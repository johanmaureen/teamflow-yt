...
import { BoltNew } from "@/components/ui/svgs/boltNew";
import { Firebase } from "@/components/ui/svgs/firebase";
import { BeaconLogo } from "@/components/ui/svgs/beaconLogo";
import { Vercel } from "@/components/ui/svgs/vercel";
import BackgroundImage from "@/public/night-backgound.png";
import HeroImage from "@/public/screenshots.png";
            ...
            >
              <div className="mask-b-from-55% relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                <div className="inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-6xl overflow-hidden rounded-2xl border p-4 shadow-lg shadow-zinc-950/15 ring-1">
                  <Image
                    className="bg-background aspect-15/8 relative hidden rounded-2xl dark:block object-contain opject-top"
                    src={HeroImage}
                    alt="app screen"
                    width="2700"
                    height="1440"
                  />
                  <Image
                    className="z-2 border-border/25 aspect-15/8 relative rounded-2xl border dark:hidden object-contain opject-top"
                    src={HeroImage}
                    alt="app screen"
                    width="2700"
                    height="1440"
          ...
          <div className="group relative m-auto max-w-5xl px-6">
            ...
            <div className="group-hover:blur-xs **:fill-foreground mx-auto mt-12 grid max-w-2xl grid-cols-3 gap-x-12 gap-y-8 transition-all duration-500 group-hover:opacity-50 sm:gap-x-16 sm:gap-y-14 md:grid-cols-4">
              <div className="flex items-center">
                <BoltNew className="mx-auto h-5 w-full" />
              </div>
              <div className="flex items-center">
                <Vercel className="mx-auto h-4 w-full" />
              </div>
              <div className="flex items-center">
              ...
              <div className="flex items-center">
                <BeaconLogo className="mx-auto h-4 w-full" />
              </div>

              <div className="flex items-center">
                <BeaconLogo className="mx-auto h-5 w-full" />
              </div>
            </div>
          </div>
        </section>
