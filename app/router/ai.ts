...
export const generateThreadSummary = base
  ...
  .route({
    method: "GET",
    path: "/ai/tread/summary",
    summary: "Genertate a thread summary",
    tags: ["ai"],
  })
  .input(
    z.object({
...
export const generateCompose = base
  ...
  .handler(async ({ input }) => {
    const system = [
      ...
      "Qutput strictly in Markdown (paragraphs and optional bullet lists). Do not output any HTML or images.",
